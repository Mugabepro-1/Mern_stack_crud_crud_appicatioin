import usermodel from "../models/User.js"
 const create=async(req,res)=>{
  try {
      const {title,firstName,lastName,position,company,businArena,employees,street,addInfo,zipCode,place,country,code,phone,email}=req.body
   const Newuser=  new usermodel({
    title,firstName,lastName,position,company,businArena,employees,street,addInfo,zipCode,place,country,code,phone,email
   })
   await Newuser.save()
